...
#include "autoware_msgs/DetectedObjectArray.h"//hw_add
#include "autoware_msgs/DetectedObject.h"//hw_add
#include<jsk_recognition_msgs/BoundingBox.h>//hw_add
#include<jsk_recognition_msgs/BoundingBoxArray.h>//hw_add
#include <tf/transform_listener.h>//hw_add
...
class ROSPixelCloudFusionApp
{
  ...
  ros::Publisher                      pixel_cloud_box_publisher_;
  ...
  void FuseCloudVisionDetections(const autoware_msgs::DetectedObjectArray::ConstPtr &in_vision_detections, const sensor_msgs::PointCloud2::ConstPtr &in_cloud_msg);
  void SyncedDetectionsCallback(const autoware_msgs::DetectedObjectArray::ConstPtr &in_vision_detections, const sensor_msgs::PointCloud2::ConstPtr &in_cloud_msg);
  //hw_end
